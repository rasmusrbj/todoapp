...
- Accepting responsibility and apologising to those affected by our mistakes, and learning
  from the experience
...
code, issues, and other contributions that are not aligned to this Code of Conduct, and
...
Report abusive, harassing, or otherwise unacceptable behaviour to **conduct@happenings.dk**.
All complaints will be reviewed and investigated promptly and fairly. Maintainers are
obliged to respect the privacy and security of the reporter of any incident.
...
2. **Warning** — A warning with consequences for continued behaviour. No interaction with
